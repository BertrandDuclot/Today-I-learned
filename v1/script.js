...
async function loadFacts() {
  const res = await fetch("https://ysvvqxyuouetlrhwrsjr.supabase.co/rest/v1/facts", {
    headers: {
      apikey:
      ...
      authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlzdnZxeHl1b3VldGxyaHdyc2pyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTU3MDI5NDMsImV4cCI6MjAzMTI3ODk0M30.mZGmhMmcAnpp2IcYUTjUmXZIht6BSXQ8qD0F5_N4wV8",
    },
  });
...
//console.log([10, 30].find((el) => el > 10));
